...
class MakefileCommentParser ( Parser ):

    grammarFileName = "MakefileComment.g4"
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "Identifier", 
                      ...
                      "Bracket_argument", "Line_comment", "DNL_comment", 
                      "Newline", "Space" ]
    ...
    class FileContext(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(MakefileCommentParser.EOF, 0)

        def command_invocation(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MakefileCommentParser.Command_invocationContext)
            else:
                return self.getTypedRuleContext(MakefileCommentParser.Command_invocationContext,i)


        def getRuleIndex(self):
            return MakefileCommentParser.RULE_file
    ...
    def file_(self):
        ...
        localctx = MakefileCommentParser.FileContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while _la==MakefileCommentParser.Identifier:
                self.state = 8
            ...
            self.state = 14
            self.match(MakefileCommentParser.EOF)
    ...
    class Command_invocationContext(ParserRuleContext):
        ...
        def Identifier(self):
            return self.getToken(MakefileCommentParser.Identifier, 0)

        def single_argument(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MakefileCommentParser.Single_argumentContext)
            else:
                return self.getTypedRuleContext(MakefileCommentParser.Single_argumentContext,i)


        def compound_argument(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MakefileCommentParser.Compound_argumentContext)
            else:
                return self.getTypedRuleContext(MakefileCommentParser.Compound_argumentContext,i)


        def getRuleIndex(self):
            return MakefileCommentParser.RULE_command_invocation
    ...
    def command_invocation(self):
        ...
        localctx = MakefileCommentParser.Command_invocationContext(self, self._ctx, self.state)
        self.enterRule(localctx, 2, self.RULE_command_invocation)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 16
            self.match(MakefileCommentParser.Identifier)
            self.state = 17
            self.match(MakefileCommentParser.T__0)
            self.state = 22
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MakefileCommentParser.T__0) | (1 << MakefileCommentParser.Identifier) | (1 << MakefileCommentParser.Unquoted_argument) | (1 << MakefileCommentParser.Quoted_argument) | (1 << MakefileCommentParser.Bracket_argument))) != 0):
                self.state = 20
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [MakefileCommentParser.Identifier, MakefileCommentParser.Unquoted_argument, MakefileCommentParser.Quoted_argument, MakefileCommentParser.Bracket_argument]:
                    self.state = 18
                    self.single_argument()
                    pass
                elif token in [MakefileCommentParser.T__0]:
                    self.state = 19
            ...
            self.state = 25
            self.match(MakefileCommentParser.T__1)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class Single_argumentContext(ParserRuleContext):
        ...
        def Unquoted_argument(self):
            return self.getToken(MakefileCommentParser.Unquoted_argument, 0)

        def Bracket_argument(self):
            return self.getToken(MakefileCommentParser.Bracket_argument, 0)

        def Quoted_argument(self):
            return self.getToken(MakefileCommentParser.Quoted_argument, 0)

        def getRuleIndex(self):
            return MakefileCommentParser.RULE_single_argument
    ...
    def single_argument(self):
        ...
        localctx = MakefileCommentParser.Single_argumentContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 27
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MakefileCommentParser.Identifier) | (1 << MakefileCommentParser.Unquoted_argument) | (1 << MakefileCommentParser.Quoted_argument) | (1 << MakefileCommentParser.Bracket_argument))) != 0)):
    ...
    class Compound_argumentContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MakefileCommentParser.RULE_compound_argument
    ...
    def compound_argument(self):
        ...
        localctx = MakefileCommentParser.Compound_argumentContext(self, self._ctx, self.state)
